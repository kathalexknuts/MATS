library("RSQLite"); require(dplyr); require(lmtest); require(data.table)
require(GMMAT); library("bigQF"); require(fastDummies)
source("~/Desktop/MATS.testing/rcpp.R")
source("~/Desktop/MATS.testing/alleleqc.R")
source("~/Desktop/MATS.testing/EZ.R")
